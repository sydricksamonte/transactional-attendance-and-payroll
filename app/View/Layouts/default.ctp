	...
	<div class="navbar">
        <div class="navbar-inner">
            <ul class="nav">
				  ...
				  <li class="divider-vertical"><div style="padding:10px;"><?php echo $this->Html->image('manpower.png')."  ";?><?php echo $this->Html->link('Man Power',array('controller'=>'Employees','action' => 'select_manpower'))?></div></li>
			</ul>
