...
<?php
	...
	echo $this->Form->input('start',array('label' =>'Start date:','options' => $weekStart, 'type' => 'select', 'value' => $weekNum ));
	echo $this->Form->input('end',array('label' => 'End date:', 'options' => $weekEnd, 'type' => 'select', 'value' => $weekNum));
