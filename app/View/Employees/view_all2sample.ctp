...
<h3>Employee Profile</h3>
	<div class="formstyle" style="width:68%;">
		Employee ID: &nbsp;&nbsp;&nbsp;
			<b><?php  $employee['Employee']['id']; ?></b>
		<br><br>Name: &nbsp;&nbsp;&nbsp;
			<b><?php  $employee['Employee']['last_name'].', '.$employee['Employee']['first_name']; ?></b>
		<br><br>Group: &nbsp;&nbsp;&nbsp;
			<b><?php  $employee['SubGroup']['name']; ?></b>
		<br><br>Status: &nbsp;&nbsp;&nbsp;
			<b><?php if ($empAuth == 1){ 'Employed';} else { 'Resigned';}?></b>
	...
	<tr>
		<td style="vertical-align:middle"><b><?php if ($empAuth == 1){  'Shift Schedule:';}?></b></td>
		<td><?php if ($empAuth == 1){  '<div class="colorw"><div class="btn btn-primary" style="width:170px">'.$this->Html->link('Add / Modify Schedule',array('action' => 'change_sched', $employee['Employee']['id']))."</div></div>";} ?></td>
	</tr>
	<tr>
	  <td><b><?php if($empAuth == 1){ 'Cut-off End Date:'; }?></b></td>
	  <td><?php  $this->Form->create('Emp',array('method' => 'post')).$this->Form->input('cut_off',array('label' => false, 'type' => 'select', 'options' =>$total, 'value' => $cutDropDown)).'</td>
	</tr>
	<tr>
...
<th> <?php  $t['CompAdvanceRule']['name']; ?> </th>
<?php endforeach; ?>
<th >Remark</th>
<th >OT</th>
...
#CODE FOR HOLIDAY
				...
				if ($trimTempStart == '' and $trimTempEnd == '' and ($trimTempCin != null or $trimTempCout != null))
				{
                 ...
                 "<tr>
                <td $bg>$trimDate </td><td $bg>"; $trimTempStart;
                if(($rd != 'yes')and($temp_start!=null and $temp_start!=0 and $temp_cin != '' and $temp_cout != '')){$dayin++;}
                 ...
                 "</td><td $bg>"; $trimTempEnd;
				 "</td><td $bg>";
								if($temp_cin == null and $remark=='ERROR'){
									 $this->Html->link('No in',array('action' => 'error', $employee['Employee']['id'], $curr_date));
								}
								else if($temp_cin != null and $remark=='ERROR'){
                                     $this->Html->link($trimTempCin,array('action' => 'error', $employee['Employee']['id'], $curr_date));
                                }
								else{
								     $trimTempCin;
								...
								if($temp_cin == null and $remark=='Absent'){
									 $this->Html->link('Absent',array('action' => 'error', $employee['Employee']['id'], $curr_date));}
									 "</td>
							        <td $bg>";
								
								if($temp_cout == null && $remark=='ERROR'){
									 $this->Html->link('No out',array('action' => 'error', $employee['Employee']['id'], $curr_date));
							    }
								else if($temp_cout != null and $remark=='ERROR'){
                                      $this->Html->link($trimTempCout,array('action' => 'error', $employee['Employee']['id'], $curr_date));
                                }
							    else{	
								     $trimTempCout;
								};
				if($temp_cout == null && $remark=='Absent'){
				 ...
				 "</td><td $bg>".$late."</td><td $bg>".$under."</td>";
				$bg1 = $bg;
...
########################
         ...
         "<td  $bg $fcolor>".$remark.
				...
				"</td>
				<td class='colorw' $bg>";
				 '<div class="btn btn-info">'.$this->Html->link('Edit',array('action' => 'edit_day_sched', $employee['Employee']['id'], $curr_date));
				"</td>
				</tr>";
				$curr_date += 86400;
				$ot1 = 0;$ot2 = 0;$ot3 = 0;$ot4 = 0;$ot5 = 0;
...
<?php $tagging = $this->requestAction('Employees/getComputations/'. 'OT'.'/'  );
		...
		$otamount = 0;
						foreach ($tagging as $tcode):
						{
							?><tr><td><?php ($tcode['CompAdvanceRule']['desc']);?></td><?php
							?><td><?php eval(" " .$tcode['CompAdvanceRule']['var_total']. ";");
										eval('$otinittotal =  '.$tcode["CompAdvanceRule"]["var_total"]. ";");
										$otalltotal = $otinittotal + $otalltotal; ?></td><?php
							?><td><?php eval(" formatAmount(" .$tcode["CompAdvanceRule"]["computation_rule"]. ");");
...
<td><?php  $otalltotal; ?></td>
<td><?php  formatAmount($otamount);  ?></td>
</tr>
<tr>
<td>Over Time with deductions</td>
<?php $ottotals=($otalltotal);?>
<td colspan=2><center><?php  formatAmount($deduc=$ottotals - ($ottotals * 0.10)); $otamount=$deduc;?></td>
</tr>
</table>
</td><td>
...
<td><?php  $ndalltotal; ?></td>
<td><?php  formatAmount($ndamount);  ?></td>
</tr>
...
<tr>
<td>Total Night Differential</td>
<td><?php  $hdalltotal; ?></td>
<td><?php  formatAmount($hdamount);  ?></td>
</tr>
</table>
</td></tr><tr><td>
...
<tr>
<td>Monthly rate</td>
<td><?php  $this->Html->link(formatAmount($basic),array('action' => 'edit', $employee['Employee']['id']));?></td>
</tr>
<tr>
<td>Daily Rate</td>
<td><?php  formatAmount($d_rate);?></td>
</tr>
<tr>
<td>Hour Rate</td>
<td><?php  formatAmount($h_rate);?></td>
</tr>
<tr>
<td>Minute Rate</td>
<td><?php  formatAmount($m_rate);?></td>
</tr>
...
<?php $tagging = $this->requestAction('Employees/fetchDeductions/'  );
		...
		$deduction_amount = 0;
						foreach ($tagging as $tcode):
						{
							?><tr><td><?php ($tcode['DeductionsRule']['desc']);?></td><?php
							?><td><?php eval(" " .$tcode['DeductionsRule']['var']. ";");
										eval('$dedinittotal =  '.$tcode["DeductionsRule"]["var"]. ";");
										$dedalltotal = $dedinittotal + $dedalltotal; ?></td><?php
							?><td><?php eval(" formatAmount(" .$tcode["DeductionsRule"]["computation_rule"]. ");");
...
<td>Total Amount</td>
<td><?php  null ?></td>
<td><?php  number_format($deduction_amount, 2, '.', ',');?></td>
</tr>
...
<tr>
<td>SSS</td>
<td><?php $sss = $govDeduc['Govdeduction']['sss'] / 2;  number_format($sss, 2, '.', ',');?></td>
</tr>
<tr>
<td>Philhealth</td>
<td><?php $philhealth = $govDeduc['Govdeduction']['philhealth'] / 2;  number_format($philhealth, 2, '.', ',');?></td>
</tr>
<tr>
<td>Pag-ibig</td>
<td><?php $pagibig = $govDeduc['Govdeduction']['pagibig'] / 2;  number_format($pagibig, 2, '.', ',');?></td>
</tr>
<tr>
<td>Tax</td>
<td><?php $tax = $govDeduc['Govdeduction']['tax'] / 2;  number_format($tax, 2, '.', ',');?></td>
</tr>
<tr>
<td>Total Amount</td>
<td><?php $gov_deductions =$tax + $pagibig + $philhealth + $sss;  number_format($gov_deductions, 2, '.', ',');?></td>
</tr>
</table>
</td>
</tr>
...
<td><?php
if ($ssLoan == 0){
 $this->Html->link($ssLoan,array('controller'=>'Loans','action' => 'add_loan', $employee['Employee']['id'],$ssid));
}
else{
 $this->Html->link($ssLoan,array('controller'=>'Loans','action' => 'edit_loan', $employee['Employee']['id'],$ssid));
}
?>
</td>
</tr>
...
<td><?php 
if($hmdfLoan ==0){
 $this->Html->link($hmdfLoan,array('controller'=>'Loans','action' => 'add_loan', $employee['Employee']['id'],$hmdfid));
}else{
 $this->Html->link($hmdfLoan,array('controller'=>'Loans','action' => 'edit_loan', $employee['Employee']['id'],$hmdfid));
}
?>
</td>
</tr>
...
<tr>
<td>Basic pay</td>
<td><?php $basicHalf = $basic / 2;  formatAmount($basicHalf)?></td>
</tr>
<tr>
<td>Deductions</td>
<td><?php  formatAmount('-'.$deduction_amount)?></td>
</tr>
<tr>
<td>Gov Deductions</td>
<td><?php  formatAmount('-'.$gov_deductions)?></td>
</tr>
<tr>
<td>Overtime pay</td>
<td><?php  formatAmount($otamount)?></td>
...
<tr>
<td>Net pay</td>
<td><?php  formatAmount($totalsalary + $attbonus - $ssLoan - $hmdfLoan);?></td>
</tr>
<tr>
<td>
<div class="colorw">
...
<?php
 $this->Html->link('Add Retro',array('controller'=>'Retros','action' => 'index', $employee['Employee']['id'],$cutDropDown));
$curr_date = null;
$temp_start = null;
$temp_end = null;
$temp_cin = null;
